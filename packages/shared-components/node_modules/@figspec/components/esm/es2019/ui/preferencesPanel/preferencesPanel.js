...
function rootFontSizeInPx($preferences) {
    ...
    return compute(() => {
        ...
        return el("div", [], [
            el("span", [className("pp-section-header")], ["Root font size for rem calculation"]),
            numberInput({
                $error,
            ...
            el("p", [attr("id", "root_font_size_desc"), className("pp-description")], [
...
function decimalPlaces($preferences) {
    ...
    return el("div", [], [
        ...
        el("p", [attr("id", "decimal_places_desc"), className("pp-description")], [
...
function viewportZoomSpeed($preferences) {
    ...
    return el("div", [], [
        ...
        el("p", [attr("id", "zoom_speed_desc"), className("pp-description")], ["The speed of viewport scaling action."]),
    ]);
}
function viewportPanSpeed($preferences) {
    ...
    return el("div", [], [
        ...
        el("p", [attr("id", "pan_speed_desc"), className("pp-description")], ["The speed of viewport pan/move action."]),
    ]);
}
