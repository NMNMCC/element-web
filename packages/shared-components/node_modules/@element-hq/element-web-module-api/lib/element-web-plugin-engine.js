...
function G() {
  if (tr) return ne;
  tr = 1;
  const r = W(), { MAX_LENGTH: i, MAX_SAFE_INTEGER: t } = k(), { safeRe: s, t: a } = M(), p = ke(), { compareIdentifiers: u } = Mr();
  class f {
    constructor(e, o) {
...
function Wr() {
  if (Sr) return Ae;
  Sr = 1;
  const r = Hr(), i = kr(), t = B(), s = Ye(), a = Be(), p = ze();
  return Ae = (f, n, e, o) => {
    switch (n) {
      case "===":
...
function V() {
  ...
  qe = i;
  const t = at(), s = new t(), a = ke(), p = Y(), u = W(), f = G(), {
    safeRe: n,
    t: e,
...
function Y() {
  ...
  Ce = i;
  const t = ke(), { safeRe: s, t: a } = M(), p = Wr(), u = W(), f = G(), n = V();
  return Ce;
}
var Pe, qr;
function z() {
...
function Ke() {
  if (_r) return Fe;
  _r = 1;
  const r = G(), i = Y(), { ANY: t } = i, s = V(), a = z(), p = B(), u = Be(), f = ze(), n = Ye();
  return Fe = (o, c, l, m) => {
...
function mt() {
  if (Xr) return be;
  Xr = 1;
  const r = V(), i = Y(), { ANY: t } = i, s = z(), a = F(), p = (c, l, m = {}) => {
    if (c === l)
      return !0;
...
function dt() {
  if (xr) return Me;
  xr = 1;
  const r = M(), i = k(), t = G(), s = Mr(), a = X(), p = Br(), u = Yr(), f = zr(), n = Kr(), e = Zr(), o = Jr(), c = Qr(), l = et(), m = F(), E = rt(), g = tt(), O = We(), w = st(), _ = nt(), A = B(), U = Be(), j = Hr(), C = kr(), y = Ye(), N = ze(), x = Wr(), K = it(), Z = Y(), J = V(), Q = z(), R = ot(), h = ct(), I = ut(), d = lt(), v = ft(), $ = Ke(), L = ht(), T = Et(), S = pt(), q = Rt(), D = mt();
  return Me = {
    parse: a,
    valid: p,
    clean: u,
...
class Ot extends Error {
  constructor(i) {
    super(`Plugin version ${i} is incompatible with engine version 1.9.0`);
  }
}
class gt {
  constructor(i) {
  ...
  async load(i) {
    ...
    if (!$t.satisfies("1.9.0", i.default.moduleApiVersion))
...
class At {
  ...
  watch(i) {
    this.listeners.size === 0 && this.onFirstWatch(), this.listeners.add(i);
  }
  unwatch(i) {
    this.listeners.delete(i) && this.listeners.size === 0 && this.onLastWatch();
  }
  /**
