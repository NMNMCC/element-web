...
import {
  compile
} from "./chunk-ZOSCWTVE.js";
import "./chunk-E3HQG3SX.js";
import "./chunk-4SKLNWZC.js";
import {
  __commonJS,
  __toESM
} from "./chunk-6T7F6ITK.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-PJE2H475.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-WPHRNFIR.js")).default;
  return {
