"use strict";
(globalThis["webpackChunkelement_web"] = globalThis["webpackChunkelement_web"] || []).push([[1385],{
...
/* harmony export */ });
/* harmony import */ var core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./node_modules/core-js/modules/es.array.push.js");
...
/* harmony import */ var core_js_modules_esnext_iterator_filter_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./node_modules/core-js/modules/esnext.iterator.filter.js");
...
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./node_modules/@babel/runtime/helpers/esm/defineProperty.js");
...
const ComposerContext = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_5__.createContext)(getDefaultContextValue());
ComposerContext.displayName = "ComposerContext";
function useComposerContext() {
  return (0,react__WEBPACK_IMPORTED_MODULE_5__.useContext)(ComposerContext);
}
...
var esnext_iterator_for_each = __webpack_require__("./node_modules/core-js/modules/esnext.iterator.for-each.js");
...
var esnext_iterator_find = __webpack_require__("./node_modules/core-js/modules/esnext.iterator.find.js");
...
/* harmony import */ var _KeyBindingsManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/KeyBindingsManager.ts");
/* harmony import */ var _accessibility_KeyboardShortcuts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/accessibility/KeyboardShortcuts.ts");
/* harmony import */ var _utils_blobs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/utils/blobs.ts");
/* harmony import */ var _ContentMessages__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./src/ContentMessages.ts");
/* harmony import */ var _Typeguards__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./src/Typeguards.ts");
...
event) {
  ...
  let handled = false;
  const autocompleteAction = (0,_KeyBindingsManager__WEBPACK_IMPORTED_MODULE_1__/* .getKeyBindingsManager */ .zM)().getAutocompleteAction(event);
  const component = autocompleteRef.current;
  if (component && component.countCompletions() > 0) {
    switch (autocompleteAction) {
      case _accessibility_KeyboardShortcuts__WEBPACK_IMPORTED_MODULE_2__/* .KeyBindingAction */ .bY.ForceCompleteAutocomplete:
      case _accessibility_KeyboardShortcuts__WEBPACK_IMPORTED_MODULE_2__/* .KeyBindingAction */ .bY.CompleteAutocomplete:
        autocompleteRef.current.onConfirmCompletion();
        handled = true;
        break;
      case _accessibility_KeyboardShortcuts__WEBPACK_IMPORTED_MODULE_2__/* .KeyBindingAction */ .bY.PrevSelectionInAutocomplete:
        autocompleteRef.current.moveSelection(-1);
        handled = true;
        break;
      case _accessibility_KeyboardShortcuts__WEBPACK_IMPORTED_MODULE_2__/* .KeyBindingAction */ .bY.NextSelectionInAutocomplete:
        autocompleteRef.current.moveSelection(1);
        handled = true;
        break;
      case _accessibility_KeyboardShortcuts__WEBPACK_IMPORTED_MODULE_2__/* .KeyBindingAction */ .bY.CancelAutocomplete:
...
function handleClipboardEvent(event, data, roomContext, mxClient, eventRelation) {
  ...
  if (data.files.length && !data.types.includes("text/rtf")) {
    _ContentMessages__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Ay.sharedInstance().sendContentListToRoom(Array.from(data.files), room.roomId, eventRelation, roomContext.replyToEvent, mxClient, timelineRenderingType).catch(handleError);
    return true;
  }
  ...
  if (data.types.includes("text/html")) {
    ...
    fetch(imgSrc).then(response => {
      response.blob().then(imgBlob => {
        ...
        const safetype = (0,_utils_blobs__WEBPACK_IMPORTED_MODULE_3__/* .getBlobSafeMimeType */ .F)(type);
        ...
        _ContentMessages__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Ay.sharedInstance().sendContentToRoom(file, room.roomId, eventRelation, mxClient, replyToEvent).catch(handleError);
      }).catch(handleError);
    }).catch(handleError);
    return true;
  }
...
function isEventToHandleAsClipboardEvent(event) {
  const isInputEventForClipboard = event instanceof InputEvent && event.inputType === "insertFromPaste" && (0,_Typeguards__WEBPACK_IMPORTED_MODULE_5__/* .isNotNull */ .P)(event.dataTransfer);
...
/* harmony export */ });
/* harmony import */ var matrix_js_sdk_src_matrix__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./matrix-js-sdk/src/matrix.ts");
...
/* harmony import */ var _accessibility_KeyboardShortcuts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/accessibility/KeyboardShortcuts.ts");
/* harmony import */ var _Keyboard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/Keyboard.ts");
...
const KeyboardKey = ({
  ...
  const icon = _accessibility_KeyboardShortcuts__WEBPACK_IMPORTED_MODULE_2__/* .KEY_ICON */ .GA[name];
  const alternateName = _accessibility_KeyboardShortcuts__WEBPACK_IMPORTED_MODULE_2__/* .ALTERNATE_KEY_NAME */ .hm[name];
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("kbd", null, " ", icon || alternateName && (0,_languageHandler__WEBPACK_IMPORTED_MODULE_4__._t)(alternateName) || name, " "), !last && "+");
};
const KeyboardShortcut = ({
  ...
  if (value.ctrlOrCmdKey) {
    modifiersElement.push(/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(KeyboardKey, {
      key: "ctrlOrCmdKey",
      name: _Keyboard__WEBPACK_IMPORTED_MODULE_3__/* .IS_MAC */ .vL ? _Keyboard__WEBPACK_IMPORTED_MODULE_3__/* .Key */ .Uz.META : _Keyboard__WEBPACK_IMPORTED_MODULE_3__/* .Key */ .Uz.CONTROL
    }));
  } else if (value.ctrlKey) {
    modifiersElement.push(/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(KeyboardKey, {
      key: "ctrlKey",
      name: _Keyboard__WEBPACK_IMPORTED_MODULE_3__/* .Key */ .Uz.CONTROL
    }));
  } else if (value.metaKey) {
    modifiersElement.push(/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(KeyboardKey, {
      key: "metaKey",
      name: _Keyboard__WEBPACK_IMPORTED_MODULE_3__/* .Key */ .Uz.META
    }));
  }
  if (value.altKey) {
    modifiersElement.push(/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(KeyboardKey, {
      key: "altKey",
      name: _Keyboard__WEBPACK_IMPORTED_MODULE_3__/* .Key */ .Uz.ALT
    }));
  }
  if (value.shiftKey) {
    modifiersElement.push(/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(KeyboardKey, {
      key: "shiftKey",
      name: _Keyboard__WEBPACK_IMPORTED_MODULE_3__/* .Key */ .Uz.SHIFT
    }));
  }
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", {
    className: className
  }, modifiersElement, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(KeyboardKey, {
    name: value.key,
    last: true
  }));
};
