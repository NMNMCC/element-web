"use strict";
(globalThis["webpackChunkelement_web"] = globalThis["webpackChunkelement_web"] || []).push([[7692],{
...
/* harmony import */ var core_js_modules_es_array_push_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./node_modules/core-js/modules/es.array.push.js");
...
/* harmony import */ var _utils_MegolmExportEncryption__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./src/utils/MegolmExportEncryption.ts");
...
/* harmony import */ var _components_views_auth_PassphraseField__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("./src/components/views/auth/PassphraseField.tsx");
/* harmony import */ var _components_views_auth_PassphraseConfirmField__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("./src/components/views/auth/PassphraseConfirmField.tsx");
...
class ExportE2eKeysDialog extends react__WEBPACK_IMPORTED_MODULE_3__.Component {
  constructor(props) {
    super(props);
  ...
  startExport(passphrase) {
    ...
    Promise.resolve().then(() => {
      ...
      return _utils_MegolmExportEncryption__WEBPACK_IMPORTED_MODULE_6__/* .encryptMegolmKeyFile */ .L(k, passphrase);
    }).then(f => {
      const blob = new Blob([f], {
        type: "text/plain;charset=us-ascii"
      });
      file_saver__WEBPACK_IMPORTED_MODULE_2___default().saveAs(blob, "element-keys.txt");
      this.props.onFinished(true);
    }).catch(e => {
      matrix_js_sdk_src_logger__WEBPACK_IMPORTED_MODULE_4__/* .logger */ .vF.error("Error exporting e2e keys:", e);
      if (this.unmounted) {
        return;
      }
  ...
  render() {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement(_components_views_dialogs_BaseDialog__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A, {
      className: "mx_exportE2eKeysDialog",
      onFinished: this.props.onFinished,
      title: (0,_languageHandler__WEBPACK_IMPORTED_MODULE_5__._t)("settings|key_export_import|export_title")
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement("form", {
      onSubmit: this.onPassphraseFormSubmit
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement("div", {
      className: "mx_Dialog_content"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement("p", null, (0,_languageHandler__WEBPACK_IMPORTED_MODULE_5__._t)("settings|key_export_import|export_description_1")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement("p", null, (0,_languageHandler__WEBPACK_IMPORTED_MODULE_5__._t)("settings|key_export_import|export_description_2")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement("div", {
      className: "error"
    }, this.state.errStr), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement("div", {
      className: "mx_E2eKeysDialog_inputTable"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement("div", {
      className: "mx_E2eKeysDialog_inputRow"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement(_components_views_auth_PassphraseField__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A, {
      minScore: 3,
      label: (0,_languageHandler__WEBPACK_IMPORTED_MODULE_5__/* ._td */ .AO)("settings|key_export_import|enter_passphrase"),
      labelEnterPassword: (0,_languageHandler__WEBPACK_IMPORTED_MODULE_5__/* ._td */ .AO)("settings|key_export_import|enter_passphrase"),
      labelStrongPassword: (0,_languageHandler__WEBPACK_IMPORTED_MODULE_5__/* ._td */ .AO)("settings|key_export_import|phrase_strong_enough"),
      labelAllowedButUnsafe: (0,_languageHandler__WEBPACK_IMPORTED_MODULE_5__/* ._td */ .AO)("settings|key_export_import|phrase_strong_enough"),
      ...
      className: "mx_E2eKeysDialog_inputRow"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement(_components_views_auth_PassphraseConfirmField__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A, {
      password: this.state.passphrase1,
      label: (0,_languageHandler__WEBPACK_IMPORTED_MODULE_5__/* ._td */ .AO)("settings|key_export_import|confirm_passphrase"),
      labelRequired: (0,_languageHandler__WEBPACK_IMPORTED_MODULE_5__/* ._td */ .AO)("settings|key_export_import|phrase_cannot_be_empty"),
      labelInvalid: (0,_languageHandler__WEBPACK_IMPORTED_MODULE_5__/* ._td */ .AO)("settings|key_export_import|phrase_must_match"),
      ...
      type: "submit",
      value: (0,_languageHandler__WEBPACK_IMPORTED_MODULE_5__._t)("action|export"),
      disabled: disableForm
