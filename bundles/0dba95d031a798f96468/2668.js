"use strict";
(globalThis["webpackChunkelement_web"] = globalThis["webpackChunkelement_web"] || []).push([[2668],{
...
var esm_defineProperty = __webpack_require__("./matrix-js-sdk/node_modules/@babel/runtime/helpers/esm/defineProperty.js");
...
// EXTERNAL MODULE: ./matrix-js-sdk/src/oidc/index.ts + 2 modules
var oidc = __webpack_require__("./matrix-js-sdk/src/oidc/index.ts");
;// ./matrix-js-sdk/src/rendezvous/MSC4108SignInWithQR.ts
...
class MSC4108SignInWithQR {
  ...
  constructor(channel, didScanCode, client, onFailure) {
    (0,esm_defineProperty/* default */.A)(this, "ourIntent", void 0);
    (0,esm_defineProperty/* default */.A)(this, "_code", void 0);
    (0,esm_defineProperty/* default */.A)(this, "expectingNewDeviceId", void 0);
  ...
  async negotiateProtocols() {
    ...
    if (this.didScanCode) {
      ...
      if (this.isNewDevice) {
        ...
        if ((_oidcClientConfig = oidcClientConfig) !== null && _oidcClientConfig !== void 0 && _oidcClientConfig.grant_types_supported.includes(oidc/* DEVICE_CODE_SCOPE */.AO)) {
          await this.send({
...
;// ./matrix-js-sdk/src/rendezvous/RendezvousError.ts
...
;// ./matrix-js-sdk/src/rendezvous/RendezvousFailureReason.ts
/*
Copyright 2022 The Matrix.org Foundation C.I.C.
...
;// ./matrix-js-sdk/src/rendezvous/RendezvousIntent.ts
/*
Copyright 2022 The Matrix.org Foundation C.I.C.
...
class MSC4108RendezvousSession {
  constructor({
    ...
    (0,esm_defineProperty/* default */.A)(this, "url", void 0);
    (0,esm_defineProperty/* default */.A)(this, "client", void 0);
    (0,esm_defineProperty/* default */.A)(this, "fallbackRzServer", void 0);
    (0,esm_defineProperty/* default */.A)(this, "fetchFn", void 0);
    (0,esm_defineProperty/* default */.A)(this, "onFailure", void 0);
    (0,esm_defineProperty/* default */.A)(this, "etag", void 0);
    (0,esm_defineProperty/* default */.A)(this, "expiresAt", void 0);
    (0,esm_defineProperty/* default */.A)(this, "expiresTimer", void 0);
    (0,esm_defineProperty/* default */.A)(this, "_cancelled", false);
    (0,esm_defineProperty/* default */.A)(this, "_ready", false);
...
;// ./matrix-js-sdk/src/rendezvous/transports/index.ts
/*
Copyright 2022 The Matrix.org Foundation C.I.C.
...
;// ./matrix-js-sdk/src/rendezvous/channels/MSC4108SecureChannel.ts
...
class MSC4108SecureChannel {
  constructor(rendezvousSession, theirPublicKey, onFailure) {
    (0,esm_defineProperty/* default */.A)(this, "secureChannel", void 0);
    (0,esm_defineProperty/* default */.A)(this, "establishedChannel", void 0);
    (0,esm_defineProperty/* default */.A)(this, "connected", false);
...
;// ./matrix-js-sdk/src/rendezvous/channels/index.ts
/*
Copyright 2022 The Matrix.org Foundation C.I.C.
...
;// ./matrix-js-sdk/src/rendezvous/index.ts
/*
Copyright 2022 The Matrix.org Foundation C.I.C.
...
var modules_es_array_push = __webpack_require__("./node_modules/core-js/modules/es.array.push.js");
// EXTERNAL MODULE: ./node_modules/core-js/modules/esnext.iterator.filter.js
var modules_esnext_iterator_filter = __webpack_require__("./node_modules/core-js/modules/esnext.iterator.filter.js");
// EXTERNAL MODULE: ./node_modules/core-js/modules/esnext.iterator.for-each.js
var modules_esnext_iterator_for_each = __webpack_require__("./node_modules/core-js/modules/esnext.iterator.for-each.js");
...
var modules_esnext_iterator_constructor = __webpack_require__("./node_modules/core-js/modules/esnext.iterator.constructor.js");
// EXTERNAL MODULE: ./node_modules/core-js/modules/esnext.iterator.map.js
var modules_esnext_iterator_map = __webpack_require__("./node_modules/core-js/modules/esnext.iterator.map.js");
...
const MFAInput = /*#__PURE__*/(0,react.forwardRef)(function MFAInput2(_ref, ref) {
  ...
  return /* @__PURE__ */(0,jsx_runtime.jsxs)("div", {
    className: classes,
    children: [/* @__PURE__ */(0,jsx_runtime.jsx)("input", MFA_objectSpread(MFA_objectSpread({}, props), {}, {
      inputMode: "numeric",
      type: "text",
      minLength: 0,
      maxLength: length,
...
const MFAControl = /*#__PURE__*/(/* unused pure expression or super */ null && (forwardRef(function ActionControl(props, ref) {
  return /* @__PURE__ */jsx(Control, {
    asChild: true,
    children: /* @__PURE__ */jsx(MFAInput, MFA_objectSpread({
      ref
    }, props))
  });
})));
  ...
  render() {
    ...
    switch (this.props.phase) {
      ...
      case LoginWithQR_types/* Phase */.a0.OutOfBandConfirmation:
        ...
        }, (0,languageHandler._t)("auth|qr_code_login|check_code_input_label")), /*#__PURE__*/react.createElement(MFAInput, {
      ...
      case LoginWithQR_types/* Phase */.a0.ShowingQR:
        if (this.props.code) {
          ...
          main = /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(Heading/* Heading */.D, {
            ...
            brand: SdkConfig/* default */.Ay.get().brand
  ...
  constructor(props) {
    ...
    (0,defineProperty/* default */.A)(this, "generateAndShowCode", async () => {
      ...
      try {
        ...
        await ((_rendezvous = rendezvous) === null || _rendezvous === void 0 ? void 0 : _rendezvous.cancel(e instanceof RendezvousError ? e.code : ClientRendezvousFailureReason.Unknown));
      }
    });
    ...
    (0,defineProperty/* default */.A)(this, "onClick", async (type, checkCode) => {
      ...
      switch (type) {
        case LoginWithQR_types/* Click */.HY.Cancel:
          await ((_this$state$rendezvou2 = this.state.rendezvous) === null || _this$state$rendezvou2 === void 0 ? void 0 : _this$state$rendezvou2.cancel(MSC4108FailureReason.UserCancelled));
          this.reset();
        ...
        case LoginWithQR_types/* Click */.HY.Back:
          await ((_this$state$rendezvou4 = this.state.rendezvous) === null || _this$state$rendezvou4 === void 0 ? void 0 : _this$state$rendezvou4.cancel(MSC4108FailureReason.UserCancelled));
          this.onFinished(false);
          break;
