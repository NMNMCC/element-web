"use strict";
(globalThis["webpackChunkelement_web"] = globalThis["webpackChunkelement_web"] || []).push([[395,4006,8227],{
...
/* harmony import */ var core_js_modules_esnext_iterator_constructor_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./node_modules/core-js/modules/esnext.iterator.constructor.js");
...
/* harmony import */ var _dialogs_BaseDialog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./src/components/views/dialogs/BaseDialog.tsx");
/* harmony import */ var _utils_location__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./src/utils/location/index.ts");
/* harmony import */ var _Map__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./src/components/views/location/Map.tsx");
/* harmony import */ var _SmartMarker__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("./src/components/views/location/SmartMarker.tsx");
/* harmony import */ var _ZoomButtons__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("./src/components/views/location/ZoomButtons.tsx");
 ...
 */
class LocationViewDialog extends react__WEBPACK_IMPORTED_MODULE_3__.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const markerRoomMember = (0,_utils_location__WEBPACK_IMPORTED_MODULE_5__/* .isSelfLocation */ .qy)(mxEvent.getContent()) && mxEvent.sender || undefined;
    const geoUri = (0,_utils_location__WEBPACK_IMPORTED_MODULE_5__/* .locationEventGeoUri */ .jm)(mxEvent);
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement(_dialogs_BaseDialog__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A, {
      className: "mx_LocationViewDialog",
      onFinished: this.props.onFinished,
      fixedWidth: false
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement(_Map__WEBPACK_IMPORTED_MODULE_6__["default"], {
      id: this.getBodyId(),
      centerGeoUri: geoUri,
      ...
      map
    }) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement(react__WEBPACK_IMPORTED_MODULE_3__.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement(_SmartMarker__WEBPACK_IMPORTED_MODULE_7__["default"], {
      map: map,
      id: `${this.getBodyId()}-marker`,
      geoUri: geoUri,
      roomMember: markerRoomMember
    }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement(_ZoomButtons__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A, {
      map: map
    }))));
  }
}
...
/* harmony import */ var _utils_location_map__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./src/utils/location/map.ts");
/* harmony import */ var _Marker__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./src/components/views/location/Marker.tsx");
...
const useMapMarker = (map, geoUri) => {
  const [marker, setMarker] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)();
  const onElementRef = (0,react__WEBPACK_IMPORTED_MODULE_2__.useCallback)(element => {
    if (marker || !element) {
      return;
    }
    const coords = (0,_utils_location__WEBPACK_IMPORTED_MODULE_3__/* .parseGeoUri */ .XB)(geoUri);
    if (coords) {
      const newMarker = (0,_utils_location_map__WEBPACK_IMPORTED_MODULE_4__/* .createMarker */ .h)(coords, element);
      newMarker.addTo(map);
      setMarker(newMarker);
    }
  }, [marker, geoUri, map]);
...
const SmartMarker = ({
  ...
  return (
    ...
    react__WEBPACK_IMPORTED_MODULE_2__.createElement("span", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.createElement(_Marker__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A, {
      ref: onElementRef,
      id: id,
...
/* harmony import */ var core_js_modules_esnext_iterator_map_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_esnext_iterator_map_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./node_modules/react/index.js");
/* harmony import */ var _vector_im_compound_design_tokens_assets_web_icons__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./node_modules/@vector-im/compound-design-tokens/assets/web/icons/minus.js");
/* harmony import */ var _vector_im_compound_design_tokens_assets_web_icons__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./node_modules/@vector-im/compound-design-tokens/assets/web/icons/plus.js");
/* harmony import */ var _languageHandler__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./src/languageHandler.tsx");
/* harmony import */ var _elements_AccessibleButton__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./src/components/views/elements/AccessibleButton.tsx");
...
const ZoomButtons = ({
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.createElement(_elements_AccessibleButton__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A, {
    onClick: onZoomIn,
    "data-testid": "map-zoom-in-button",
    title: (0,_languageHandler__WEBPACK_IMPORTED_MODULE_5__._t)("action|zoom_in"),
    className: "mx_ZoomButtons_button"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.createElement(_vector_im_compound_design_tokens_assets_web_icons__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A, {
    className: "mx_ZoomButtons_icon"
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.createElement(_elements_AccessibleButton__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A, {
    onClick: onZoomOut,
    "data-testid": "map-zoom-out-button",
    title: (0,_languageHandler__WEBPACK_IMPORTED_MODULE_5__._t)("action|zoom_out"),
    className: "mx_ZoomButtons_button"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__.createElement(_vector_im_compound_design_tokens_assets_web_icons__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A, {
    className: "mx_ZoomButtons_icon"
  })));
};
...
/* harmony import */ var maplibre_gl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./node_modules/maplibre-gl/dist/maplibre-gl.js");
...
/* harmony import */ var matrix_js_sdk_src_logger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./matrix-js-sdk/src/logger.ts");
/* harmony import */ var _languageHandler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/languageHandler.tsx");
/* harmony import */ var _findMapStyleUrl__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./src/utils/location/findMapStyleUrl.ts");
/* harmony import */ var _LocationShareErrors__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./src/utils/location/LocationShareErrors.ts");
...
const createMap = (client, interactive, bodyId, onError) => {
  try {
    const styleUrl = (0,_findMapStyleUrl__WEBPACK_IMPORTED_MODULE_4__/* .findMapStyleUrl */ .M)(client);
    const map = new maplibre_gl__WEBPACK_IMPORTED_MODULE_1__.Map({
      container: bodyId,
      style: styleUrl,
      zoom: 15,
      interactive,
      ...
      locale: {
        "AttributionControl.ToggleAttribution": (0,_languageHandler__WEBPACK_IMPORTED_MODULE_3__._t)("location_sharing|toggle_attribution"),
        "AttributionControl.MapFeedback": (0,_languageHandler__WEBPACK_IMPORTED_MODULE_3__._t)("location_sharing|map_feedback"),
        "FullscreenControl.Enter": (0,_languageHandler__WEBPACK_IMPORTED_MODULE_3__._t)("action|enter_fullscreen"),
        "FullscreenControl.Exit": (0,_languageHandler__WEBPACK_IMPORTED_MODULE_3__._t)("action|exit_fullscreeen"),
        "GeolocateControl.FindMyLocation": (0,_languageHandler__WEBPACK_IMPORTED_MODULE_3__._t)("location_sharing|find_my_location"),
        "GeolocateControl.LocationNotAvailable": (0,_languageHandler__WEBPACK_IMPORTED_MODULE_3__._t)("location_sharing|location_not_available"),
        "LogoControl.Title": (0,_languageHandler__WEBPACK_IMPORTED_MODULE_3__._t)("location_sharing|mapbox_logo"),
        "NavigationControl.ResetBearing": (0,_languageHandler__WEBPACK_IMPORTED_MODULE_3__._t)("location_sharing|reset_bearing"),
        "NavigationControl.ZoomIn": (0,_languageHandler__WEBPACK_IMPORTED_MODULE_3__._t)("action|zoom_in"),
        "NavigationControl.ZoomOut": (0,_languageHandler__WEBPACK_IMPORTED_MODULE_3__._t)("action|zoom_out")
      }
    });
    map.addControl(new maplibre_gl__WEBPACK_IMPORTED_MODULE_1__.AttributionControl(), "top-right");
    map.on("error", e => {
      matrix_js_sdk_src_logger__WEBPACK_IMPORTED_MODULE_2__/* .logger */ .vF.error("Failed to load map: check map_style_url in config.json has a valid URL and API key", e.error);
      onError === null || onError === void 0 || onError(new Error(_LocationShareErrors__WEBPACK_IMPORTED_MODULE_5__/* .LocationShareError */ .$.MapStyleUrlNotReachable));
    });
    return map;
  } catch (e) {
    matrix_js_sdk_src_logger__WEBPACK_IMPORTED_MODULE_2__/* .logger */ .vF.error("Failed to render map", e);
    const errorMessage = e === null || e === void 0 ? void 0 : e.message;
    if (errorMessage.includes("Failed to initialize WebGL")) throw new Error(_LocationShareErrors__WEBPACK_IMPORTED_MODULE_5__/* .LocationShareError */ .$.WebGLNotEnabled);
    throw e;
  }
};
const createMarker = (coords, element) => {
  const marker = new maplibre_gl__WEBPACK_IMPORTED_MODULE_1__.Marker({
    element,
    anchor: "bottom",
    offset: [0, -1]
  }).setLngLat({
